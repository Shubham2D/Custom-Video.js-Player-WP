...
function cvjp_video_shortcode($atts) {
    ...
    ob_start();
    ?>
    <div class="video-container" style="max-width: <?php echo esc_attr($atts['width']); ?>px; margin: auto;">
        <video class="video-js vjs-default-skin" controls preload="auto" data-setup='{"fluid": true, "controlBar": { "pictureInPictureToggle": true }}'>
